package com.wenderson.curso.config;
...
import com.wenderson.curso.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(p1.getCategories().add(cat2));
		...
		User u3 = new User(null, "Wenderson Farias", "wenderson@gmail.com", "65992619192", "123789");
